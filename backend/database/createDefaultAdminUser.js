...
const createDefaultAdmin = async () => {
  try {
    ...
    if (defaultAdminEmail === undefined || defaultAdminPassword === undefined) {
      ...
      throw new Error(
        "Default admin check or new admin creation failed. Please provide admin email & password parameter in .env file"
      );
    } else {
    ...
    console.log(error);
    console.log("Default admin check or new admin creation failed.");
  }
};
