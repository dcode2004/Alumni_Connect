          ...
          {/* left_section */}
             <div className={`${styles.left_section} ${styles.hero_main_items}`} >
                  <h1 className={`${styles.hero_heading} font-bold`} >
                      ...
                      <span className='text-sky-500' >Alumni Portal</span><br />
                      website.
                   </h1>
                   <p className='text-sm' >Managed & maintained by <span className='text-sky-500' >LNMIIT</span> students</p>
                  <TypeWriter />
                   <p className={styles.hero_text} >
                   This website is developed to keep all LNMIIT students at one place. It includes all the semester notes, questions and assignments. This website will help to connect their seniors, juniors & classmates.
                   </p>
                   <div>
